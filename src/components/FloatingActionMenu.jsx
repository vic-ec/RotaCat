...
//   same bottom edge, so the two never overlap; this menu renders nothing
//   while hidden. No page currently needs it: bulk selection used to claim
//   that edge, but its controls now live inline in `SelectAllRow`.
