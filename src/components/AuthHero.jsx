...
export default function AuthHero() {
  return (
    <div className="flex flex-col items-center justify-center bg-canvas-raised px-6 py-5 sm:px-10 md:w-1/2 md:border-r md:border-accent/25 md:px-10 lg:px-[4.375rem] md:py-20">
      ...
      <p className="mt-[15px] whitespace-nowrap text-sm text-ink-muted sm:text-base md:text-lg lg:text-[22px]">
        ...
        <span className="relative inline-block">
          ...
          <img
            src={butterflyLoop}
            alt=""
            className="absolute -top-[12.5px] -right-[7.5px] h-[23px] w-[23px] -rotate-10 select-none"
            draggable="false"
          />
        </span>
      </p>
