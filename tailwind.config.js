  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        shift: {
          '08': 'rgb(var(--color-shift-08) / <alpha-value>)',  // #E6F5F1
          '12': 'rgb(var(--color-shift-12) / <alpha-value>)',  // #C7E8E0
          '13': 'rgb(var(--color-shift-13) / <alpha-value>)',  // #B7E0D6
          '15': 'rgb(var(--color-shift-15) / <alpha-value>)',  // #A5D6CB
          '20': 'rgb(var(--color-shift-20) / <alpha-value>)',  // #F0CFDB
          '22': 'rgb(var(--color-shift-22) / <alpha-value>)'   // #E4B6C7
        },
