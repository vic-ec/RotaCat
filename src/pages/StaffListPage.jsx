...
const CATEGORY_LABELS = {
  ...
  Locum:       'Locum',
  // Legacy values (kept for existing staff_reference rows)
  COSMO:       'COSMO',
...
export default function StaffListPage() {
  const [tab, setTab] = useState('reference') // 'reference' | 'pending'
  ...
  async function loadAll() {
    ...
    const [refRes, pendingRes] = await Promise.all([
      supabase
  ...
  const categoryOrder = ['MO', 'Registrar', 'EC_COSMO', 'OT_COSMO', 'COSMO_Psych', 'COSMO', 'COSMOPsych', 'Consultant']
