...
export default function BackButton({ onClick, className = '' }) {
  ...
  return (
    <button
      ...
      aria-label="Back"
      className={`fixed z-20 flex h-9 w-9 items-center justify-center rounded-full border-[0.2px] border-white/80 bg-ink/25 text-canvas backdrop-blur-md transition-colors hover:bg-ink/40 active:bg-ink/40 ${
