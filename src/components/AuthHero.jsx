...
export default function AuthHero() {
  return (
    <div className="flex flex-col items-center justify-center bg-accent/50 px-6 py-[4.375rem] sm:px-10 md:w-1/2 md:border-r md:border-accent/25 md:px-10 lg:px-[4.375rem]
 md:py-20">
