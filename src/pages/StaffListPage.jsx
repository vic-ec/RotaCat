            ...
            <>
              <div className="card mb-3 overflow-hidden">
                <SelectAllRow
                  ...
                  actions={[
                    { label: 'Approve selected', icon: <CircleCheck className="h-5 w-5" />, onClick: bulkApprovePending },
                    { label: 'Reject selected', icon: <CircleX className="h-5 w-5" />, onClick: bulkRejectPending, tone: 'danger' },
                  ]}
            ...
            <>
              <div className="card overflow-hidden divide-y divide-slate-line">
                <SelectAllRow
                  ...
                  actions={[
                    { label: 'Approve selected', icon: <CircleCheck className="h-5 w-5" />, onClick: bulkApproveRequests },
                    { label: 'Reject selected', icon: <CircleX className="h-5 w-5" />, onClick: bulkRejectRequests, tone: 'danger' },
                  ]}
