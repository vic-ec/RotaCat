...
describe('FloatingActionMenu', () => {
  ...
  // A page rendering its own bottom-fixed element takes the same
  // bottom-right corner — the two must never be on screen together, not even
  // for the frame the FAB's own collapse animation would otherwise run for.
